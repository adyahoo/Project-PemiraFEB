  ...
  <nav class="navbar navbar-transparent navbar-color-on-scroll fixed-top navbar-expand-lg" color-on-scroll="100" id="sectionsNav">
    <div class="container">
      <div class="navbar-translate">
        <a class="navbar-brand" href="/">KPRM 2021 </a>
        ...
        <div class="tab">        
          <div class="team">
            <div class="row justify-content-center">
              ...
              @else
              <h1 class="title title__error">
                @error('item_tab_bem')
                  {{$message}}
                @enderror
                @error('item_tab_prodi')
                  {{$message}}
                @enderror
              </h1>
                ...
                <label>
                  ...
                  <div class="card card-plain">
                    ...
                    <div class="card-footer justify-content-center">
                      <button type="button" class="btn btn-danger btn-round" onclick="location.href='/kandidat/bem/{{$i->id}}'">
              ...
              <div class="col-md-4">
                <label>
                  ...
                  <div class="card card-plain">
                    ...
                    <div class="card-footer justify-content-center">
                      <button type="button" class="btn btn-danger btn-round" onclick="location.href='/kandidat/prodi/{{$i->id}}'">
                        <i class="material-icons">person</i> Lihat kandidat
                      </button> 
                    </div>
                  </div>
      ...
      <div class="row">
        <div class="col-md-12 ml-auto mr-auto">
          <div class="alert alert-success" role="alert">
            ...
            <h4>Terima kasih telah menggunakan hak suara anda dalam Pemilihan Gubernur dan Wakil Gubernur BEM FEB UNUD 2021</h4>
            ara anda dalam Pemilihan Gubernur dan Wakil Gubernur BEM FISIP UNUD 2020</h4>
            <hr>
          </div>
        </div>
      </div>
