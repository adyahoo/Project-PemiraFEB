...
<body class="">
  ...
  <script src={{asset('admin/assets/js/dist/Chart.min.js')}} type="text/javascript"></script>
  <script src={{asset('admin/assets/js/dist/utils.js')}} type="text/javascript"></script>
